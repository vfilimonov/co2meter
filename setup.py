...
setup(name='CO2meter',
      ...
      entry_points={
          'console_scripts': ['co2meter_server = co2meter.server:start_server',
                              'co2meter_homekit = co2meter.homekit:start_homekit',
                              'co2meter_server_homekit = co2meter.homekit:start_server_homekit',
                              ],
      },
